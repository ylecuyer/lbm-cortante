	...
	*/
	...
	void fuerzas(float referencia[3][3], float deformado[3][3], float fuerzas[3][3], float ks)
	{
	...
	*/
	...
	void rotacion(float referencia[3][3], float deformado[3][3], float nfuerzas[3][3], float ks)
	{
